...
public enum L10n {
    private static let table: [AppLanguage: [LKey: String]] = [
        ...
        .es: [
            ...
            .licenseTrialDaysLeft: "%d día(s) restante(s) de tu prueba",
            .licenseThisMac: "Esta Mac",
            .licenseGetHelp: "Obtener ayuda",
            .copyAction: "Copiar",
            .appAbout: "Acerca de Markzzy",
            .appVersion: "Versión",
            ...
            .licenseWelcomeBack: "Hola de nuevo",
            ...
            .iPhoneWaitingBridgeNote: "Detectado: %@. Si tu iPhone está conectado a través suyo, aparecerá apenas envíe imagen. Para usar Continuity nativa de Apple, cierra la app de arriba.",
            .iPhoneReconnectingTitle: "iPhone desconectado",
            .iPhoneReconnectingHint: "Apple impone un bloqueo de hasta ~10 minutos después de tocar Desconectar. Markzzy reconectará automáticamente cuando iOS lo permita.\n\nPara acelerar:\n  • Conecta tu iPhone con cable USB (instantáneo)\n  • Reinicia el iPhone (siempre funciona)",
            ...
            .licenseHeroTrialEndsToday: "Tu prueba termina hoy",
            ...
            .licenseHeroChargeOnFormat: "Te cobramos $10 el %@ · cancela antes y no se te cobra",
            .licenseHeroCancelBeforeEnds: "Cancela antes de que termine la prueba y no se te cobra",
            .licenseHeroLifetimeBlurb: "Paga una vez, úsalo para siempre. Incluye todas las actualizaciones futuras.",
            ...
            .licenseHeroPlanPickerLabel: "Elige un plan para actualizar",
            ...
            .licenseReactivateBody: "¿Cambiaste de opinión? Reactívala antes de esa fecha y nada cambia.",
            ...
            .outputStorageEstimateFormat: "A calidad %@, puedes grabar aproximadamente **%@** antes de quedarte sin espacio.",
